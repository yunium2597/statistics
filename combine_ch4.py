...
output_file = "statistics_ch4_vi.md"

with open(output_file, "w", encoding="utf-8") as outfile:
    for i in range(1, 6):
        chunk_file = f"stat_chunk4_{i}_vi.md"
...
for f in glob.glob("stat_chunk4_*.md"):
    os.remove(f)
if os.path.exists("stat_ch4.pdf"):
    os.remove("stat_ch4.pdf")
if os.path.exists("stat_ch4.md"):
    os.remove("stat_ch4.md")
