...
output_file = "statistics_ch9_vi.md"

with open(output_file, "w", encoding="utf-8") as outfile:
    for i in range(1, 4):
        chunk_file = f"stat_chunk9_{i}_vi.md"
...
for f in glob.glob("stat_chunk9_*.md"):
    os.remove(f)
if os.path.exists("stat_ch9.pdf"):
    os.remove("stat_ch9.pdf")
if os.path.exists("stat_ch9.md"):
    os.remove("stat_ch9.md")
