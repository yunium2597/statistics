...
output_file = "statistics_ch3_vi.md"

with open(output_file, "w", encoding="utf-8") as outfile:
    for i in range(1, 7):
        chunk_file = f"stat_chunk3_{i}_vi.md"
...
for f in glob.glob("stat_chunk3_*.md"):
    os.remove(f)
if os.path.exists("stat_ch3.pdf"):
    os.remove("stat_ch3.pdf")
if os.path.exists("stat_ch3.md"):
    os.remove("stat_ch3.md")
